    ...
    <div className="mx-auto w-full p-4 sm:p-6 lg:p-8">
      <div className="mb-8 flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-ink-2">Your AI-generated courses and their progress.</p>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="rounded-2xl border border-dashed border-line-2 bg-bg-soft p-12 text-center">
          ...
          <p className="mx-auto mt-2 max-w-[42ch] text-sm text-ink-2">
            Tell our AI what you want to learn and it&rsquo;ll build a full course with hands-on labs
            in seconds.
          </p>
